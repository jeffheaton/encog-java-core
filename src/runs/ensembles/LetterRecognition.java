...
public class LetterRecognition {
	...
	private static List<Double> trainingErrors = Arrays.asList(0.03);
	private static int trainingSetSize = 16000;
	private static double activationThreshold = 0.4;
	...
	public static void main(String[] args) {
		//TODO: use args
		dataLoader = new DataLoader(new LetterMapper(outputs, activationThreshold,lowBound),trainingSetSize,readInputs,inputs,inputsReversed);
