...
cat ~/projects/mscproject/data_plots/training_curves/${technique}-${problem}-${neurons}-1.data ~/projects/mscproject/data_plots/training_curves/${technique}-${problem}-${neurons}-2.data ~/projects/mscproject/data_plots/training_curves/${technique}-${problem}-${neurons}-3.data | sort -n > ~/projects/mscproject/data_plots/training_curves/${technique}-${problem}-${neurons}.data
