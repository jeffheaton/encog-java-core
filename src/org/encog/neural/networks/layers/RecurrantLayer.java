...
public class RecurrantLayer extends BasicLayer implements Serializable,
	 ...
	 */
	public RecurrantLayer(final ActivationFunction thresholdFunction,
	 ...
	 *            How many neurons in this layer.
	 */
	public RecurrantLayer(final int neuronCount) {
	 ...
	 */
	public RecurrantLayer cloneStructure() {
		return new RecurrantLayer(this.activationFunction, getNeuronCount());
	}
