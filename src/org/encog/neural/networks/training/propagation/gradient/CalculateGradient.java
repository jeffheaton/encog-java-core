...
/**
 * This class calculates the gradients for all of the weights and thresholds
 * in a neural network.  These gradients are returned as a single-dimension
 * double array.  This class uses a training set and is multithreaded.  
 * The multithreading provided by this class allows all of the 
 * propagation training methods to run in multithreaded mode.
 */
