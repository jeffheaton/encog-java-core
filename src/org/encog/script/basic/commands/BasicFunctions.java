...
/**
 * Provides the execution for all of the built-in basic functions.
 */
public class BasicFunctions {
	...
	public void fnCDbl(BasicVariable target) {
		...
		case typeString:
			target.edit(Double.parseDouble(var.getStr()));
			break;
		case typeFloat:
			target.edit((double) var.getFloat());
			break;
		case typeInteger:
			target.edit((double) var.getShort());
			break;
		case typeLong:
			target.edit((double) var.getLong());
			break;
		case typeDouble:
			target.edit(var.getDouble());
			break;
		case typeByte:
			target.edit((double) var.getByte());
			break;
		case typeBoolean:
			target.edit((double) (var.getBoolean() ? -1 : 0));
			break;
		default:
	...
	public void fnCInt(BasicVariable target) {
		...
		switch (var.getObjectType()) {
		case typeString:
			target.edit((short) Double.parseDouble(var.getStr()));
			break;
		case typeFloat:
			target.edit((short) var.getFloat());
			break;
		case typeInteger:
			target.edit(var.getShort());
			break;
		case typeLong:
			target.edit((short) var.getLong());
			break;
		case typeDouble:
			target.edit((short) var.getDouble());
			break;
		case typeByte:
			target.edit((short) var.getByte());
			break;
		case typeBoolean:
			target.edit((short) (var.getBoolean() ? -1 : 0));
			break;
		default:
			throw (new BasicError(ErrorNumbers.errorType));
		}
	...
	public void fnCLng(BasicVariable target) {
		...
		switch (var.getObjectType()) {
		case typeString:
			target.edit((long) Double.parseDouble(var.getStr()));
			break;
		case typeFloat:
			target.edit((long) var.getFloat());
			break;
		case typeInteger:
			target.edit((long) var.getShort());
			break;
		case typeLong:
			target.edit(var.getLong());
			break;
		case typeDouble:
			target.edit((long) var.getDouble());
			break;
		case typeByte:
			target.edit((long) var.getByte());
			break;
		case typeBoolean:
			target.edit((var.getBoolean() ? -1 : 0));
			break;
		default:
			throw (new BasicError(ErrorNumbers.errorType));
		}
	...
	public void fnMid(BasicVariable target) {
		...
		if (n == 3) {
			if ((varObj2.getShort() + varObj3.getShort()) <= varObj1.getStr()
					.length()) {
	...
	public void fnMsgBox(BasicVariable target) {
		...
		case 2:
			...
			break;
		case 3:
			boolean r = JOptionPane.showConfirmDialog(null, a.getStr(), b
					.getStr(), JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
			target.edit(r);
			break;
		default:
			target.edit(0);
