 ...
 *
 */
public class MultiquadricFunctionMulti implements RadialBasisFunctionMulti {
	/**
	 ...
	 */
	public MultiquadricFunctionMulti(final double peak, final double[] center,
			final double[] width) {
		this.center = center;
		this.peak = peak;
		this.width = width;
	 ...
	 */
	public MultiquadricFunctionMulti(final int dimensions, final double peak,
