...
public class EncogCodeGeneration {
	 ...
	 * @param method The machine learning method to generate from.
	 * @param data The data to use perform generation.
	 */
	 ...
	 * @param method The filename of the method.
	 ...
	 * @param embedData True, if data should embeded.
	 */
