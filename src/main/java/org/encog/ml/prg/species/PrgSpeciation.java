...
public class PrgSpeciation implements Speciation {
	 ...
	 *            The genome to add.
	 */
	private void addSpeciesMember(final Species species,
			final EncogProgram genome) {
	...
	public void init(final EvolutionaryAlgorithm theOwner) {
		this.owner = theOwner;
		this.population = (PrgPopulation) theOwner.getPopulation();
	...
	private void speciateAndCalculateSpawnLevels(final List<Genome> genomes) {
		...
		for (final Genome g : genomes) {
			...
			final EncogProgram genome = (EncogProgram) g;
