...
public class TestYahooDownload extends TestCase {
	...
	public void testYahooDownloadCSV() throws IOException
    {
        ...
        Assert.assertEquals("20000110,0,432.5,451.25,420,436.06,61022400,109.01",tr.readLine());
        ...
        Assert.assertEquals("20000105,0,430.5,431.13,402,410.5,83194800,102.62", tr.readLine());
        tr.close();
    }
