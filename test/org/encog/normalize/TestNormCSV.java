...
public class TestNormCSV extends TestCase {
	...
	private void generate()
	{
		...
		norm.addInputField(d = new InputFieldArray2D(ARRAY_2D,3));
		norm.addInputField(e = new InputFieldArray2D(ARRAY_2D,4));
	...
	public void testGenerateAndLoad()
	{
		...
		norm.addInputField(d = new InputFieldCSV(FILENAME,3));
		norm.addInputField(e = new InputFieldCSV(FILENAME,4));
